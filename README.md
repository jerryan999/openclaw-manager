...
**CI 自动构建**：推送版本 tag（如 `v0.0.7`）后，[GitHub Actions](.github/workflows/build.yml) 会自动同时构建 macOS 与 Windows 版本，并创建 **GitHub Release**，安装包可直接在 [Releases](https://github.com/miaoxworld/openclaw-manager/releases) 页面下载。
